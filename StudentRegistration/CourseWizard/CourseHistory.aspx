<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="CourseHistory.aspx.cs" Inherits="StudentRegistration.CourseWizard.CourseHistory" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                        <ContentTemplate>
                            ...
                            <asp:Table ID="ClassScheduleTable" CssClass="table table-bordered" runat="server" Visible="false">
                               ...
                               <asp:TableHeaderCell ID="Status" runat="server" Text="Status" />
