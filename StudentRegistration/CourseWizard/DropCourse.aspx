<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.Master" CodeBehind="DropCourse.aspx.cs" Inherits="StudentRegistration.CourseWizard.CourseAdd" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Always">
                        <ContentTemplate>
                            <asp:Table ID="CourseListTable" CssClass="table table-bordered" runat="server" Visible="false">
                                ...
                                <br />
                                <asp:Button runat="server" ID="btnAddCourse"  OnClick="btnAddCourse_Click" Text="Drop Course" CssClass="btn btn-default" Visible="false" />
